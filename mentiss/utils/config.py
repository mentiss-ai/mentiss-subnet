...
def add_validator_args(cls, parser):
    ...
    parser.add_argument(
        "--mentiss.api_key",
        type=str,
        help="Bearer token for Mentiss API. Falls back to MENTISS_API_KEY env var.",
        default=None,
    )
    ...
    parser.add_argument(
        "--mentiss.role",
        type=str,
        help="Role for the miner to play (werewolf faction).",
        default="werewolf",
    )
    ...
    parser.add_argument(
        "--mentiss.reward_threshold",
        type=float,
        help="Win rate threshold for sigmoid reward (inflection point).",
        default=0.30,
    )

    parser.add_argument(
        "--mentiss.reward_steepness",
        type=float,
        help="Steepness of sigmoid reward function.",
        default=20.0,
    )

    parser.add_argument(
        "--mentiss.poll_interval",
        type=float,
        help="Seconds between game status polls.",
        default=2.0,
    )
